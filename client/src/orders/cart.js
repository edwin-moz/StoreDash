...
export const Cart = ({ chosenStoreId, distributor, orderInventory, orderTotal }) => {
    // hooks
    ...
    return (
        <motion.div animate={{ opacity: 1, x: 0, }} initial={{ opacity: 0, x: 100 }} className="bg-white border-l-2 hidden w-[30rem] md:block">
            ...
            <ul className="flex flex-col gap-5 overflow-scroll py-5">
